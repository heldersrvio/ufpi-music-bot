...
public class TesteProva1 {
    ...
    @Test
    public void testeCadastroUsuario() throws SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroUsuarioJaCadastrado() throws ValorInvalido, UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroUsuarioStringIdentificadorInvalido() throws UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroUsuarioStringNomeInvalido() throws UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroUsuarioStringEmailInvalido() throws UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroUsuarioStringSenhaInvalida() throws UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    public void testeCadastroBandaComArtistaInvalido() throws SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroEstilo() throws SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    public void testeCadastroEstiloJaCadastrado() throws ValorInvalido, EstiloJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroEstiloInvalido() throws SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroPlayList() throws ValorInvalido, UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroPlayListNomeInvalido() throws ValorInvalido, UsuarioJaCadastrado, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    public void testeCadastroPlayListJaExistente()
            throws ValorInvalido, UsuarioJaCadastrado, UsuarioNaoCadastrado, PlaylistExistente, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeCadastroPlayListemUsuarioNaoCadastrado() throws SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaEstiloNaoCadastrado() throws ValorInvalido, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloJaCadastrado, UsuarioJaCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        gregorianCalendar.set(2019, Calendar.FEBRUARY, 20);
    ...
    @Test
    public void testeAdicionarMusicaAssinante() throws ValorInvalido, MusicaJaCadastrada, EstiloJaCadastrado, EstiloNaoCadastrado, UsuarioJaCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaArtistaInexistente() throws ValorInvalido, MusicaJaCadastrada, EstiloJaCadastrado, EstiloNaoCadastrado, UsuarioJaCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    public void testeAdicionarMusicaValoresInvalidos() throws UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloJaCadastrado, UsuarioJaCadastrado, EstiloNaoCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        try {
            gregorianCalendar.set(2019, Calendar.JUNE, 20);
    ...
    @Test
    public void testeAdicionarMusicaJaCadastrada() throws ValorInvalido, UsuarioNaoCadastrado, EstiloJaCadastrado, UsuarioJaCadastrado, EstiloNaoCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testePesquisarPorEstilo() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testePesquisarPorData() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        gregorianCalendar.set(2018, Calendar.JUNE, 20);
        milisegundos = gregorianCalendar.getTimeInMillis();
        Date lancamento2 = new Date(milisegundos);

        gregorianCalendar.set(2017, Calendar.JUNE, 20);
        milisegundos = gregorianCalendar.getTimeInMillis();
        ...
        gregorianCalendar.set(2016, Calendar.JUNE, 20);
        milisegundos = gregorianCalendar.getTimeInMillis();
        Date lancamento = new Date(milisegundos);
    ...
    @Test
    public void testePesquisarPorArtista() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaPlaylistUsuarioNaoCadastrado() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaPlaylistNaoExistente() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, MusicaNaoCadastrada, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaNaoCadastradaPlaylist() throws ValorInvalido, UsuarioJaCadastrado, UsuarioNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaJaCadastrada, EstiloNaoCadastrado, EstiloJaCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaJaCadastradaPlaylist() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeAdicionarMusicaPlaylist() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada, MusicaJaCadastrada, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testePesquisaPlaylistUsuarioNaoCadastrado() throws ValorInvalido, UsuarioJaCadastrado, PlaylistExistente, PlaylistNaoExistente, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testePesquisaPlaylistNaoExistente() throws ValorInvalido, UsuarioJaCadastrado, UsuarioNaoCadastrado, PlaylistExistente, SQLException, ClassNotFoundException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testePesquisaPlaylistEstiloUsuarioNaoCadastrado() throws PlaylistNaoExistente, MusicaNaoCadastrada, MusicaJaCadastrada, ValorInvalido, UsuarioJaCadastrado, EstiloNaoCadastrado, EstiloJaCadastrado, PlaylistExistente, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        try {
            ...
            ufpiMusic.adicionarMusica("zeca", "Babylon", "MPB", "https://www.ufpimusic/zeca/babylon.mp3", 440, lancamento);
            ufpiMusic.adicionarMusica("alceu", "La Belle de Jour", "MPB", "https://www.ufpimusic/alceu/laBelleDeJour.mp3", 430, lancamento);
            ufpiMusic.adicionarMusica("mabel", "Dont Call Me Up", "Pop", "https://www.ufpimusic/mabel/dontCallMeUp.mp3", 240, lancamento);
        ...
        try {
            ...
            ufpiMusic.adicionarMusicaPlaylist("carlos", "Variados", "mabel", "Dont Call Me Up");
    ...
    @Test
    public void testePesquisaPlaylistNaoExistenteEstilo() throws ValorInvalido, UsuarioJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, EstiloJaCadastrado, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeTempoTotalPlaylist() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada, SQLException, ClassNotFoundException, ParseException {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
    ...
    @Test
    public void testeRemoverEstilo() throws SQLException, ClassNotFoundException, UsuarioJaCadastrado, ValorInvalido, EstiloJaCadastrado, EstiloNaoCadastrado, MusicaJaCadastrada, ParseException, UsuarioNaoCadastrado, PlaylistExistente, MusicaNaoCadastrada, PlaylistNaoExistente {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        ufpiMusic.cadastrarUsuario(assinante);
        ufpiMusic.cadastrarEstilo("MPB");
        ufpiMusic.cadastrarEstilo("Jazz");
        ...
        ufpiMusic.adicionarMusica("zeca", "Telegrama", "Jazz", "https://www.ufpimusic/zeca/telegrama.mp3", 426, lancamento);
        ufpiMusic.adicionarMusica("alceu", "Coracao Bobo", "MPB", "https://www.ufpimusic/alceu/telegrama.mp3", 412, lancamento);
        ufpiMusic.adicionarMusica("zeca", "Babylon", "Jazz", "https://www.ufpimusic/zeca/babylon.mp3", 440, lancamento);
        ufpiMusic.adicionarMusica("alceu", "La Belle de Jour", "MPB", "https://www.ufpimusic/alceu/laBelleDeJour.mp3", 430, lancamento);
        ...
        ufpiMusic.removerEstilo("jazz");
        Playlist playlist = daoP.pesquisarPor("classicos", "carlos");
        assertEquals(playlist.getMusicas().size(), 2);
        try{
            daoM.pesquisarPor("babylon", "zeca");
            fail("Deveria ter gerado musicao nao cadastrada. ");
        }catch (MusicaNaoCadastrada e){
            // Excecao esperada
        }
    ...
    @Test
    public void testeJuntarUsuarios() throws SQLException, ClassNotFoundException, UsuarioJaCadastrado, ValorInvalido, EstiloJaCadastrado, EstiloNaoCadastrado, MusicaJaCadastrada, ParseException, UsuarioNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada {
        daoU.removerTodos();
        daoM.removerTodos();
        daoP.removerTodos();
        daoE.removerTodos();
        ...
        Usuario artista2 = new Artista("alceu", "Alceu Valenca", "alceu@mail.com", "seualceu");
        Usuario assinante = new Assinante("carlos", "Carlos Campelo", "carlos@mail.com", "Carlitos");
        Usuario assinante2 = new Assinante("claudio", "Carlos Campelo", "carlos@gmail.com", "Carlitos");
        ...
        ufpiMusic.criarPlaylist("carlos", "Classicos");
        ufpiMusic.criarPlaylist("claudio", "Moderna");
        Usuario assinante3 = new Assinante("aurelio", "Aurelio Marques", "aurelio@gmail.com", "aurelio123");
        ufpiMusic.cadastrarUsuario(assinante3);
        ufpiMusic.adicionarMusicaPlaylist("carlos", "Classicos", "zeca", "Telegrama");
        ufpiMusic.adicionarMusicaPlaylist("carlos", "Classicos", "alceu", "La Belle de Jour");
        ufpiMusic.adicionarMusicaPlaylist("claudio", "Moderna", "alceu", "Coracao Bobo");
        ufpiMusic.adicionarMusicaPlaylist("claudio", "Moderna", "zeca", "Babylon");

        ufpiMusic.juntarUsuarios("carlos", "claudio", "aurelio");
        try{
            daoU.pesquisarPor("carlos");
            fail("Deveria ter gerado usuario nao cadastrado");
        }catch (UsuarioNaoCadastrado e){
            //Excecao esperado
        }

        daoP.pesquisarPor("classicos", "aurelio");
        daoP.pesquisarPor("moderna", "aurelio");
    }
}

...
//A exce??o UsuarioNaoCadastrado realmente era esperada, um assinante n?o pode adicionar m?sicas ao UFPI Music.
    ...
    public void testePesquisarPorEstilo() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado {
        ...
        ufpiMusic.adicionarMusica("zeca", "Telegrama", "MPB", "https://www.ufpimusic/zeca/telegrama.mp3", 426, lancamento);
        ufpiMusic.adicionarMusica("alceu", "Cora??o Bobo", "MPB", "https://www.ufpimusic/alceu/telegrama.mp3", 412, lancamento);
    ...
    public void testePesquisarPorData() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado {
        ...
        ufpiMusic.adicionarMusica("alceu", "Cora??o Bobo", "MPB", "https://www.ufpimusic/alceu/telegrama.mp3", 412, lancamento1);
...
//}
    ...
    @Test
    public void testeRemoverEstilo() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada {
        ...
        ufpiMusic.adicionarMusica("mabel", "Ring Ring", "Pop", "https://www.ufpimusic/mabel/ringRing.mp3", 400, lancamento);
    ...
    @Test
    public void testeJuntarUsuarios() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado, PlaylistExistente, PlaylistNaoExistente, MusicaNaoCadastrada {
        UFPIMusic ufpiMusic = new UFPIMusic();
